...
// сделано так, чтобы если окружение удалено, то таймер бы его не вызывался
// это избавило бы нас от проверок лишних в обработчиках

// idea: эта delayed возможно надо в каждом объекте иметь да и все, как базовое апи.
// другое дело что я хотел сделать vz.tools...
