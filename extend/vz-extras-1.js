// ситуация такая что то что далее написано нифига не удобно. можнО, но на практике неудобно.
...
export default function setup(vz) {
   ...
   vz.register_feature( "find_objects", (env) => {
  ...
  vz.register_feature( "track_objects", (env) => {
  ...
  vz.register_feature( "objects_param", (obj) => {
  ...
  vz.register_feature( "param_alias", (obj) => {
  ...
  /////////////////////////////////////////////////////////////////////   
  vz.register_feature( "param_mirror", (obj) => {
  ...
  /////////////////////////////////////////////////////////////////////   
  vz.register_feature( "tree_items", (obj) => {
	...
	vz.register_feature( "find_track", (obj) => {
  ...
  /////////////////////////////////////////////////////////////////////   
	...
	vz.register_feature( "delayed", (env) => {
      env.delayed = delayed;
  });
