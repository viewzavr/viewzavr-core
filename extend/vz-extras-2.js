...
export function find_objects0(env) {
  ...
  /* критерия это текст, устроенный как набор строк, разделенных переводом или символом | вида:
...
export function track_objects0(env) {
...
export function objects_param0(obj) {
